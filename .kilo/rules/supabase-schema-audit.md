...
Read `.kilo/skills/supabase-schema-audit/SKILL.md` and follow its loop structure exactly. Do not run destructive SQL. All DDL changes must go through Supabase CLI migrations. Require double-confirmation before any `db push`.
