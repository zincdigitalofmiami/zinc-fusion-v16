...
Read `.kilo/skills/data-review/SKILL.md` and follow its loop structure exactly. Do not modify data or run destructive SQL. All findings are reported, not fixed, within this skill.
