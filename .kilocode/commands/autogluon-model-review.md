...
Read the full skill file at `.kilocode/skills/autogluon-model-review/SKILL.md` and follow it exactly — including all loop structure, approval gates, commit intent gates, Hard Rules, and project constants. Do not skip or abbreviate any loop.
