...
Four structured audit skills live in `.github/skills/`. Each has a full loop-based workflow with approval gates, commit intent gates, and Hard Rules. Read the full SKILL.md before starting any skill — do not shortcut the loops.

| Skill                      | File                                             | When to Use                                                                                                                                                                                                                                        |
| -------------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **autogluon-model-review** | `.github/skills/autogluon-model-review/SKILL.md` | Reviewing `python/fusion/` — model config, training gate, specialist/horizon structure, AutoGluon gotchas, Phase 5 readiness                                                                                                                       |
| **pipeline-phase-gate**    | `.github/skills/pipeline-phase-gate/SKILL.md`    | Declaring a phase done, verifying Gates 1–6 have documented passing evidence, checking phase hand-off readiness                                                                                                                                    |
| **supabase-schema-audit**  | `.github/skills/supabase-schema-audit/SKILL.md`  | Auditing RLS, constraints, indexes, migration drift, all 9 schemas present and correct                                                                                                                                                             |
| **indicator-review**       | `.github/skills/indicator-review/SKILL.md`       | Verifying indicator math, checking signal value for ZL forecasting, identifying overtooled/redundant features, auditing GARCH/Monte Carlo specs                                                                                                    |
| **data-review**            | `.github/skills/data-review/SKILL.md`            | Auditing data freshness across all tables, checking pg_cron pipeline health, verifying all 11 specialists have required data, assessing whether 2026 macro/trade/policy environment is captured in training data, producing prioritized gap report |
